...
import romper from "../../assets/Romper.json";
import Popup from "../Popup";


const Romper = ({handleAddToCart }) => {
  ...
  const totalPage = Math.ceil(romper.length / itemsPerPage);
  const startIdx = (currentPage - 1) * itemsPerPage;
  const currentItems = romper.slice(startIdx, startIdx + itemsPerPage);

  return (
    <div className="NewArrival">
      <h1 className="newarrival-big-title">ROMPER</h1>
